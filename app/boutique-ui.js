...
function Illu({ k, col, s = 46 }) {
  ...
  if (k === "pissa") return wrap(<><rect x="7" y="14" width="32" height="17" rx="4" fill="#D9A441" /><rect x="9.5" y="16.5" width="27" height="12" rx="3" fill={col} /><g stroke="#CD9468" strokeWidth="1.7" strokeLinecap="round"><line x1="12" y1="17" x2="20" y2="28" /><line x1="19" y1="17" x2="27" y2="28" /><line x1="26" y1="17" x2="34" y2="28" /><line x1="20" y1="17" x2="12" y2="28" /><line x1="27" y1="17" x2="19" y2="28" /><line x1="34" y1="17" x2="26" y2="28" /></g><g fill="#241F17"><circle cx="15" cy="22.5" r="1.8" /><circle cx="23" cy="19.5" r="1.8" /><circle cx="23" cy="26" r="1.8" /><circle cx="31" cy="22.5" r="1.8" /></g></>);
  if (k === "miel") return wrap(<><line x1="33" y1="9" x2="39" y2="21" stroke="#A9742E" strokeWidth="2.2" strokeLinecap="round" /><ellipse cx="38.5" cy="20.5" rx="3" ry="3.6" fill="#C9912F" /><path d="M36.2 18.4 h4.6 M36 20.8 h4.8 M36.4 23.2 h3.8" stroke="#8a5e22" strokeWidth="0.8" strokeLinecap="round" /><path d="M12 24 q0 -3 3 -3 h14 q3 0 3 3 v10 q0 4 -4 4 h-12 q-4 0 -4 -4 z" fill={col} /><rect x="15" y="26" width="3" height="10" rx="1.5" fill={hl} /><path d="M10 22 q12 -6 26 0 l-2.4 3.1 q-10.6 -4 -21.2 0 z" fill="#EBDCB8" stroke="#D8C49A" strokeWidth="0.7" /><path d="M18 24 q4 2.6 8 0" stroke="#C9912F" strokeWidth="1.3" fill="none" strokeLinecap="round" /><g transform="translate(22 9.5)"><ellipse cx="-4.4" cy="-1" rx="3" ry="1.8" fill="#dff1f4" opacity=".85" /><ellipse cx="4.4" cy="-1" rx="3" ry="1.8" fill="#dff1f4" opacity=".85" /><ellipse cx="0" cy="0.4" rx="4.5" ry="3.5" fill="#F2C53D" /><path d="M-1.6 -2.6 v6 M1.6 -2.6 v6" stroke="#3a2a12" strokeWidth="1.4" /><circle cx="0" cy="-4.4" r="1.4" fill="#2a1f10" /></g></>);
